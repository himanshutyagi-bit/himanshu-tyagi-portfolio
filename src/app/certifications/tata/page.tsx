...
export default function TataCertificationPage() {
  return (
    <div className="flex flex-col gap-12 pb-20 items-center justify-center min-h-[80vh] px-4 sm:px-6 relative">
      ...
      >
        ...
        <a href="/certificates/tata.jpg" download className="flex items-center gap-2 text-[#3b82f6] hover:text-[#3b82f6]/80 transition-colors group">
      ...
      >
        <div className="flex flex-col items-center text-center gap-4">
           <div className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">
             <span className="w-2 h-2 rounded-full bg-[#3b82f6]"></span> TATA (ON FORAGE)
           </div>
        ...
        <div className="w-full glass-card-dark !p-4 md:!p-8 shadow-[0_0_50px_rgba(59,130,246,0.15)] border-white/10 flex items-center justify-center bg-[#151620]/80">
          <div className="w-full max-w-4xl aspect-[1.414/1] relative rounded-lg overflow-hidden border border-white/10 bg-[#0d0e15] flex items-center justify-center group">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-zinc-600 gap-2 p-10 text-center">
              ...
              <span className="text-xs">Please save your Tata certificate image as <code className="text-[#3b82f6]">public/certificates/tata.jpg</code> in your project folder.</span>
            </div>
            
            <img 
              src="/certificates/tata.jpg" 
