...
export default function ResumePage() {
  return (
    <div className="flex flex-col gap-12 pb-20 items-center justify-center min-h-[80vh] px-4 sm:px-6 relative">
      {/* Background Glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#8b5cf6]/15 blur-[150px] rounded-full pointer-events-none" />
      ...
      >
        ...
        <a href="/resume.jpg" download className="flex items-center gap-2 text-[#8b5cf6] hover:text-[#8b5cf6]/80 transition-colors group">
          <span className="text-[10px] font-bold uppercase tracking-widest">Download Resume</span>
          <div className="size-8 rounded-full bg-[#8b5cf6]/10 flex items-center justify-center border border-[#8b5cf6]/20 group-hover:bg-[#8b5cf6]/20 transition-colors">
      ...
      >
        <div className="flex flex-col items-center text-center gap-4">
           <div className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">
             <span className="w-2 h-2 rounded-full bg-[#8b5cf6]"></span> HIMANSHU TYAGI
           </div>
        ...
        <div className="w-full glass-card-dark !p-4 md:!p-8 shadow-[0_0_50px_rgba(139,92,246,0.15)] border-white/10 flex items-center justify-center bg-[#151620]/80">
          <div className="w-full max-w-4xl aspect-[1/1.414] relative rounded-lg overflow-hidden border border-white/10 bg-[#0d0e15] flex items-center justify-center group">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-zinc-600 gap-2 p-10 text-center">
              ...
              <span className="text-xs">Please save your resume image as <code className="text-[#8b5cf6]">public/resume.jpg</code> in your project folder.</span>
            </div>
            
            <img 
              src="/resume.jpg" 
              alt="Himanshu Tyagi - Resume" 
              className="w-full h-full object-contain relative z-10 bg-white/5"
              onError={(e) => {
